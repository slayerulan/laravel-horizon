...
class RoleCrud extends Crud
{
	 ...
	 * @var string
	 */
	public $route_slug 				= 'admin-user-group-';
	/**
	...
	public function insert(RoleRequest $request)
	{
	  $user_id = Session::get('user_id');
		$this->log('User Group Added From Admin',$user_id);
	...
	{
	    $user_id = Session::get('user_id');
		$this->log('User Group Updated From Admin',$user_id);
	...
	{
	    $user_id = Session::get('user_id');
		$this->log('User Group Deleted From Admin',$user_id);
