...
class SupportTicketCrud extends Crud
{
    ...
    public function show()
    {
		...
		return view('admin/support-ticket/admin_support_ticket_list',['add_button' => $add_button,'support_ticket' => $totalData,'ticket_status_type' => $ticket_status_type,'profile_image' => $this->profile_image, 'parent_menu' => $this->parent_menu, 'sub_menu' =>$this->sub_menu]);
    }
	/**
    ...
    public function getAddTicket()
    {
        ...
        return view('admin/support-ticket/admin_add_ticket',['department' => $department, 'ticketType' => $ticketType,  'priority' => $priority, 'statusType' => $statusType,  'profile_image' => $this->profile_image, 'parent_menu' => $this->parent_menu, 'sub_menu' =>$this->sub_menu]);
    }
    ...
    $users = checkParentIds($player_id); //checkParentIds defined in helpers
        ...
        return view('admin/support-ticket/admin_edit_ticket',['player' => $player, 'ticketData' => $ticket_data,'allUsers' => $users,'department' => $department, 'ticketType' => $ticketType,  'priority' => $priority, 'statusType' => $statusType,  'profile_image' => $this->profile_image, 'parent_menu' => $this->parent_menu, 'sub_menu' =>$this->sub_menu]);
