     ...
     <div class="history_listing_body">
      @foreach($combination as $key1=>$val1)
               

        <div class="accordion">
               <div class="accordion-group history_accordion">
                  <div class="accordion-heading history_listing_body">
                     <a class="accordion-toggle combo_bet_detail bet_listin" data-toggle="collapse" id="{{'betDetails_'.$val1['id'].'_search'}}" href="{{'#collapse_'.$bet_number.'_'.$key1.'_search'}}">
                      <div class="history_item">
                         <ul>
                            ...
                            <li>{{oddsValue($val1['odds_value'])}}</li>
                         </ul>
                  ...
                  <div id="{{'collapse_'.$bet_number.'_'.$key1.'_search'}}" class="accordion-body bet_listin_in collapse animated zoomIn " data-original-title="" title="">
