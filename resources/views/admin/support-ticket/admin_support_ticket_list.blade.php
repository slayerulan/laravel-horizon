@extends('admin.layout.adminlayout')
    ...
    <div class="header"><h2>Support Tickets</h2></div>
		@if($add_button)
				...
				<tbody>
                    ...
                    <tr>
                        ...
                        <td>
													...
													<a href="{{ url('/').'/apex-site-admin/support-ticket-management/all-support-tickets/edit-ticket/'.$support_ticket_data['id'] }}" class="waves-effect btn btn-warning"><i class="material-icons">create</i>Edit</a>
													<a href="{{ url('/').'/apex-site-admin/support-ticket-management/all-support-tickets/delete/'.$support_ticket_data['id'] }}" class="waves-effect delete_button btn btn-danger"><i class="material-icons">delete_sweep</i>Delete</a>
												</td>
                    </tr>
                    @endforeach
				</tbody>
