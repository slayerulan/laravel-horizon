            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="user-data" action="{{route('admin-sub-agent-management-sub-agent-update')}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select name="role_id" id="role_id" class="form-control show-tick" onchange="getAgents(this.value)" data-live-search="true" tabindex="-98" required>
                                                    ...
                                                    <option value="{{ $role_permissions_data->id }}" @if($user_data[0]->role_id==$role_permissions_data->id) selected @endif>{{ $role_permissions_data->role_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
